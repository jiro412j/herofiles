...
/** @nocollapse */
HotTableRegisterer.ctorParameters = () => [];

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
const AVAILABLE_OPTIONS = ['allowEmpty', 'allowHtml', 'allowInsertColumn', 'allowInsertRow',
...
const AVAILABLE_HOOKS = ['afterBeginEditing', 'afterCellMetaReset', 'afterChange',
...
class HotSettingsResolver {
    ...
    mergeSettings(component) {
        ...
        this.options.forEach((key) => {
            const /** @type {?} */ option = component[key];
            if (option !== void 0) {
                mergedSettings[key] = option;
            }
        });
        this.hooks.forEach((key) => {
            const /** @type {?} */ hook = component[key];
    ...
    prepareChanges(changes) {
        const /** @type {?} */ result = {};
        const /** @type {?} */ parameters = Object.keys(changes);
...
/** @nocollapse */
HotSettingsResolver.ctorParameters = () => [];
...
class HotTableComponent {
     ...
     */
    constructor(el, _ngZone, _hotTableRegisterer, _hotSettingsResolver) {
        this.el = el;
        ...
        this.afterLanguageChange = new EventEmitter();
        this.afterListen = new EventEmitter();
        ...
        this.afterRemoveCellMeta = new EventEmitter();
        ...
        this.afterUnlisten = new EventEmitter();
        ...
        this.beforeLanguageChange = new EventEmitter();
        ...
        this.beforeRemoveCellMeta = new EventEmitter();
     ...
     */
    ngAfterContentInit() {
        const /** @type {?} */ options = this._hotSettingsResolver.mergeSettings(this);
    ...
    ngOnChanges(changes) {
        ...
        const /** @type {?} */ newOptions = this._hotSettingsResolver.prepareChanges(changes);
     ...
     */
    removeColumn(column) {
        const /** @type {?} */ index = this.columnsComponents.indexOf(column);
...
HotTableComponent.propDecorators = {
    ...
    "afterLanguageChange": [{ type: Output },],
    "afterListen": [{ type: Output },],
    ...
    "afterRemoveCellMeta": [{ type: Output },],
    ...
    "beforeLanguageChange": [{ type: Output },],
    ...
    "beforeRemoveCellMeta": [{ type: Output },],
